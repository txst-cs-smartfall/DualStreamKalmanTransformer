...
class MMTransformer(nn.Module):
    def __init__(self, mocap_frames= 600, acc_frames = 256, num_joints = 31, in_chans = 3,
                  acc_coords = 3, spatial_embed = 32, sdepth = 4, adepth = 4, tdepth = 4, num_heads = 8, mlp_ratio = 2, qkv_bias = True, qk_scale = None, op_type = 'cls', embed_type = 'lin', drop_rate =0.2, attn_drop_rate = 0.2, drop_path_rate = 0.2, norm_layer = None, num_classes = 11):
        super().__init__()
        ...
        self.Spatial_pozs_embed = nn.Parameter(torch.zeros((1, self.num_joints+1, spatial_embed)))
