...
def get_args():
    ...
    parser.add_argument('--teacher-args', default= str, help = 'A dictionary for teacher model args')
    parser.add_argument('--student-args', default= str, help = 'A dictionary for student model args')
