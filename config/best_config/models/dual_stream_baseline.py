...
Architecture (DualStreamBaseline ~18K params):
...
Expected results:
    ...
    - DualStreamBaseline: ~88-90% F1 (all components working)
...
if __name__ == "__main__":
    ...
    # Test DualStreamBaseline with 8 channels (with SMV)
    print("\n" + "=" * 50)
    print("Test 1: DualStreamBaseline - 8 channels (with SMV)")
    print("=" * 50)

    model_8ch = DualStreamBaseline(
        imu_frames=seq_len,
        imu_channels=8,
        acc_dim=48,
        gyro_dim=16,
    ...
    # Test DualStreamBaseline with 6 channels (no SMV)
    print("\n" + "=" * 50)
    print("Test 2: DualStreamBaseline - 6 channels (no SMV)")
    print("=" * 50)

    model_6ch = DualStreamBaseline(
        imu_frames=seq_len,
        imu_channels=6,
        acc_dim=48,
        gyro_dim=16,
